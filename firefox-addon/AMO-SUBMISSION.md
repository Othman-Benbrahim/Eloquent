...
Si le portail AMO le demande, téléversez `dist/eloquent-local-assistant-0.1.7-source.zip` dans la section consacrée au code source. Les instructions de construction sont dans le README et aucune étape de minification ou compilation n’est requise.
